...
p.tr_color {
	...
	<div class="div_head">
		<span> <span style="float: left;">当前位置是：类型管理-》文章类型修改</span> <span
		...
		<span>
			...
			<input type ="hidden" name="action" value="delete">
				...
				%>
					...
					<% }%>
				</select> <input value="删除"   style=" height: 23px;"type="submit" />
			</form>
		 </span>
	</div>
		...
		<table class="table_a" border="1" width="100%">
			<tbody>
				...
				<tr id="product4" style="font-family: fantasy;">
					...
					<td><a href ="modifyarticletypeok.jsp?id=<%=at.getId() %>">修改</a></td>
