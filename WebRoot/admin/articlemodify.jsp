...
p.tr_color {
	...
	<div class="div_head">
		<span> <span style="float: left;">当前位置是：类型管理-》文章修改</span> <span
	...
	<div style="font-size: 13px; margin: 10px 5px;">
		<table class="table_a" border="1" width="100%">
			<tbody>
				...
				<tr id="product4" style="font-family: fantasy;">
					...
					<td><a 
						href="articlemodifyok.jsp?id=<%=art.getId()%>"
						>修改 </a>
					</td>
				</tr>
				<%
		...
		<a href="articlemodify.jsp?pageno=<%=page_no - 1%>">上一页</a> 
		<a href="articlemodify.jsp?pageno=<%=page_no + 1%>">下一页</a>
	</div>
</body>
</html>