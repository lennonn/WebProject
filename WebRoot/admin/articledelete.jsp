...
p.tr_color {
	...
	<div class="div_head">
		<span> <span style="float: left;">当前位置是：类型管理-》删除文章</span> <span
			style="float: right; margin-right: 8px; font-weight: bold;"> <a
				style="text-decoration: none;" href="#">后台首页</a> </span> </span>
	</div>
	<div></div>
	...
	<div style="font-size: 13px; margin: 10px 5px;">
		<table class="table_a" border="1" width="100%">
			<tbody>
				...
				<tr id="product4" style="font-family: fantasy;">
					...
					<td><a target="right"
						href="../ArticleServlet?action=delete&id=<%=art.getId()%>"
		...
		<a href="articledelete.jsp?pageno=<%=page_no - 1%>">上一页</a> <a
			href="articledelete.jsp?pageno=<%=page_no + 1%>">下一页</a>
	</div>
</body>
</html>