...
public class SysDictTypeController {
    protected static final Logger logger = LoggerFactory.getLogger(SysDictTypeController.class);
   ...
   @RequestMapping("list")
    public String list(Model model) {
        ...
        return "/admin/sysdicttype/sysDictTypeList";
    }
    ...
    public String  initTable(String searchText,@RequestParam Integer pageNumber,@RequestParam Integer pageSize){
        ...
        List<SysDictType> list = sysDictTypeService.selectByQueryParams(searchText);
    ...
    public Map<String,Object>  delete(@RequestParam String id){
        ...
        try {
            sysDictTypeService.deleteByPrimaryKey(id);
    ...
    @ResponseBody
    public Map<String,Object> save(@Valid SysDictType sysDictType) {
        Map<String, Object> resultMap = new HashMap<String, Object>();
        try {
            if(sysDictType.getId()==null||sysDictType.getId().equals("")) {
