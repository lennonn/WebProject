...
public class ControllerGenerator extends CodeGeneratorManager implements CodeGenerator {
	...
	public void genCode(String tableName, String modelName, String sign) {
		...
		try {
			File controllerFile = new File(CodeGeneratorManager.PROJECT_PATH + CodeGeneratorConfig.JAVA_PATH + CodeGeneratorConfig.PACKAGE_PATH_CONTROLLER+ customMapping
